...
DNABERT-2 uses custom model code; trust_remote_code=True is required.
"""
import argparse
import json
import sys
...
def main() -> None:
    ...
    parser.add_argument(
        "--model", default="zhihan1996/DNABERT-2",
        help="HuggingFace model name or local checkpoint path. Default: zhihan1996/DNABERT-2.",
    )
