...
|---|---|---|---|---|---|
| 1 | [@hyunhwan-bcm](https://github.com/hyunhwan-bcm) | Fold-safe cross-cell depletion prior + pre-screen guide XGBoost | 0.1784 | 0.7332 | [hyunhwan-bcm-crosscell-depletion-guide](submissions/hyunhwan-bcm-crosscell-depletion-guide/) |
